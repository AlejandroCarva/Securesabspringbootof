...
@Repository
public interface IAsistenciaRepository extends JpaRepository<AsistenciaAmbiente, Long> {
    ...
    List<AsistenciaAmbiente> findByUsuarioIdUsuario(@Param("usuarioId") Long usuarioId);
    ...
    @Modifying
    @Transactional
    @Query("UPDATE AsistenciaAmbiente a SET a.estadoAsistencia = :estado WHERE a.id = :id")
    void updateEstadoAsistencia(@Param("id") Long id, @Param("estado") String estado);
    ...
    boolean existsByIdAndInstructorId(@Param("id") Long id, @Param("instructorId") Integer instructorId);
