...
public class InstructorController {
    ...
    // 🔹 AHORA USAMOS FichaService (sin la I)
    ...
    public String asistenciaFicha(@PathVariable Integer id,
        ...
        try {
            ...
            if (ficha.getPrograma() != null && ficha.getPrograma().getId() != null) {
                competencias = competenciaService.obtenerCompetenciasPorPrograma(ficha.getPrograma().getId());
            } else {
    ...
    public String consultarAsistencias(
        ...
        try {
            ...
            for (Ficha ficha : fichas) {
                ...
                Long aprendicesCount = usuarioService.contarAprendicesPorFicha(ficha.getId());
            ...
            if (ficha_id != null) {
                fichaSeleccionada = fichas.stream()
                        .filter(f -> f.getId().equals(ficha_id))
                        .findFirst()
                        .orElse(null);
    ...
    public String procesarNovedad(@RequestParam Long idJustificacion,
        ...
        try {
            ...
            justificacionService.procesarJustificacion(
                    idJustificacion.intValue(),
                    idAsistenciaAmbiente != null ? idAsistenciaAmbiente.intValue() : null,
                    accion,
                    observaciones,
    ...
    public Map<String, Object> debugUsuario(Principal principal) {
        ...
        try {
            ...
            if (idUsuario != null) {
                ...
                String rol = usuario.getFicha() == null ? "INSTRUCTOR" : "APRENDIZ";
